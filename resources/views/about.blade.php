                  ...
                  <div class="row align-items-center gx-5">
                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                      <div class="bg-light p-4 rounded-4">
                        ...
                        <div class="small fw-bolder">Coordinatrice de projets web</div>
                    ...
                    <div class="col text-center text-lg-start mb-4 mb-lg-0">
                      <div class="bg-light p-4 rounded-4">
                        ...
                        <div class="fst-italic">
                          <div class="small text-muted">Attestation d’études collégiales (AEC)</div>
                          <div class="small text-muted">Développeuse web</div>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-8">
                      <div>
                        Techniques de l'informatique – Spécialisation en conception et programmation de sites web
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body p-5">
                    ...
                    <div class="d-flex align-items-center mb-4">
                      ...
                      <h3 class="fw-bolder mb-0">
                        <span class="text-gradient d-inline"
                          >Compétences professionnelles</span
                        >
                      </h3>
                    </div>
                  ...
                  <div class="mb-0">
                    <div class="d-flex align-items-center mb-4">
                      ...
                      <h3 class="fw-bolder mb-0">
                        <span class="text-gradient d-inline">Langages</span>
                      </h3>
                    </div>
                    <div class="row row-cols-1 row-cols-md-3 mb-4">
                      <div class="col mb-4 mb-md-0">
